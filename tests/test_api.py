...
def test_create_person():
    ...
    with responses.RequestsMock() as resps:
        resps.add_callback(
            POST, "https://actionnetwork.org/api/v2/people/", callback=callback
        )
...
def test_update_person():
    ...
    with responses.RequestsMock() as resps:
        resps.add_callback(
            PUT, "https://actionnetwork.org/api/v2/people/0", callback=callback
        )
...
def test_get_person():
    ...
    def test():
        ...
        assert (
            responses.calls[0].request.url  # noqa
            == "https://actionnetwork.org/api/v2/people/?filter=email%20eq%20'jane%40example.com'"  # noqa
        )  # noqa
